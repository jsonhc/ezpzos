...
export class PreparedStatementHandler {
	...
	public static EventPerpareStatementInput(preparedStatement: PreparedStatement): PreparedStatement {
		preparedStatement = this.DefaultPrepareStatementInput(preparedStatement);
	...
	public static UserRolePrepareStatmentInput(preparedStatement: PreparedStatement):PreparedStatement{
		preparedStatement = this.DefaultPrepareStatementInput(preparedStatement);
